<div>
    ...
    @if($loading)
        <div class="text-center py-5">
            ...
            <p class="mt-3">Loading Facebook data...</p>
        </div>
    @else
        <!-- Success Message -->
        @if($success)
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="dashboard-section">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <button wire:click="refreshToken" 
                                        wire:confirm="Refresh Facebook token? This will update your access token."
                                        wire:loading.attr="disabled"
                                        class="btn btn-warning btn-sm">
                                    <span wire:loading.remove wire:target="refreshToken">
                                        <i class="fas fa-sync-alt"></i> Refresh Token
                                    </span>
                                    <span wire:loading wire:target="refreshToken">
                                ...
                                <button wire:click="disconnectAccount" 
                                        wire:confirm="Are you sure you want to disconnect Facebook? This will remove all connected data."
                                        wire:loading.attr="disabled"
                                        class="btn btn-outline-danger btn-sm">
                                    <span wire:loading.remove wire:target="disconnectAccount">
                                        <i class="fas fa-unlink"></i> Disconnect
                                    </span>
                                    <span wire:loading wire:target="disconnectAccount">
                                        <div class="spinner-border spinner-border-sm" role="status">
                                            <span class="visually-hidden">Loading...</span>
                                        </div>
                                        Disconnecting...
                        ...
                        <!-- Profile Info -->
                        <div class="profile-item d-flex align-items-center mb-3 p-3 bg-light rounded">
